...
namespace DownloadAPI
{
    public class Authentication : IAuthentication
    {
        ...
        {
            var encodedClientId = HttpUtility.UrlEncode(_configuration["ApiClientKey"]);
            var encodedClientSecret = HttpUtility.UrlEncode(_configuration["ApiClientSecret"]);
            ...
            var requestMessage = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"{httpClient.BaseAddress}/fotoweb/oauth2/token"),
